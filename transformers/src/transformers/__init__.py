...
_import_structure = {
    ...
    "models.gpt_neox_alibi": ["GPTNeoXAlibiConfig"],
    "models.gpt_neox_devarda": ["GPTNeoXDeVardaConfig"],
...
try:
    ...
    _import_structure["models.gpt_neox_alibi"].extend(
        [
    ...
    _import_structure["models.gpt_neox_devarda"].extend(
        [
            "GPTNeoXDeVardaForCausalLM",
            "GPTNeoXDeVardaLayer",
            "GPTNeoXDeVardaModel",
            "GPTNeoXDeVardaPreTrainedModel",
        ]
    )
...
if TYPE_CHECKING:
    ...
    from .models.gpt_neox_alibi import GPTNeoXAlibiConfig
    from .models.gpt_neox_devarda import GPTNeoXDeVardaConfig
    ...
    try:
        ...
        from .models.gpt_neox_alibi import (
            GPTNeoXAlibiForCausalLM,
            GPTNeoXAlibiLayer,
            GPTNeoXAlibiModel,
        )
        from .models.gpt_neox_devarda import (
            GPTNeoXDeVardaForCausalLM,
            GPTNeoXDeVardaLayer,
            GPTNeoXDeVardaModel,
        )
